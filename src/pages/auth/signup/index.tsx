    ...
    <>
      <div className="font-DMSans flex items-center justify-center h-screen bg-[#EEEEEE] text-balck w-auto">
        ...
        <div className="relative bg-white text-black mx-2 py-12 px-3 sm:px-10 w-full max-w-[604px] h-auto rounded-sm shadow-lg shadow-[#4c5551]">
          ...
          <ModalHeader headerText="Sign up" />
          ...
          <div className="">
            ...
            <button
              type="submit"
              className="w-full h-[50px] mt-10 font-medium text-base text-white hover:btnBackgroundGradient bg-gradient-to-b from-[#02EC88] to-[#5CB25D] cursor-pointer rounded-[8px]"
            >
              Proceed
            </button>
